...
let kPlacesAPIKey = "google map api key for places"
let kServicesAPIKey = "google map api key for services"
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if kPlacesAPIKey.isEmpty {
            fatalError("Please provide an API Key using kPlacesAPIKey")
        }
        
        GMSPlacesClient.provideAPIKey(kPlacesAPIKey)
        GMSServices.provideAPIKey(kServicesAPIKey)
